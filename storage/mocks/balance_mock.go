...
import (
	...
	storage "github.com/nawa/cryptoexchange-dashboard/storage"
...
func (m *MockBalanceStorage) Save(balances ...storage.Balance) error {
	varargs := []interface{}{}
...
func (mr *MockBalanceStorageMockRecorder) Save(balances ...interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockBalanceStorage)(nil).Save), balances...)
}

// FetchHourly mocks base method
func (m *MockBalanceStorage) FetchHourly(currency string, hours int) ([]storage.Balance, error) {
...
func (m *MockBalanceStorage) FetchWeekly(currency string) ([]storage.Balance, error) {
...
func (m *MockBalanceStorage) FetchMonthly(currency string) ([]storage.Balance, error) {
...
func (m *MockBalanceStorage) FetchAll(currency string) ([]storage.Balance, error) {
...
func (m *MockBalanceStorage) GetActiveCurrencies() ([]storage.Balance, error) {

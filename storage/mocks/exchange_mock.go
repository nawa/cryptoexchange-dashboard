...
func (m *MockExchange) GetBalance() (*model.Balance, error) {
...
func (m *MockExchange) GetMarketInfo(market string) (*model.MarketInfo, error) {
...
func (m *MockExchange) GetOrders() ([]model.Order, error) {
